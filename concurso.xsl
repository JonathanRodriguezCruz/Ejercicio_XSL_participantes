        ...
        <body>
            ...
            <main>
                ...
                <ol class="participantes">
                    ...
                    <li><xsl:value-of select="//participante[1]/apellidos"/>, <xsl:value-of select="//participante[1]/nombre"/>. (código) - X puntos</li>
                    <li><xsl:value-of select="//participante[2]/apellidos"/>, <xsl:value-of select="//participante[2]/nombre"/>. (código) - X puntos</li>
                    <li><xsl:value-of select="//participante[3]/apellidos"/>, <xsl:value-of select="//participante[3]/nombre"/>. (código) - X puntos</li> 
                </ol>
